...
onMounted(() => {
  ...
  $game.events.on('policeStopInitiated', onStopInitiated)
  $game.events.on('policeStopProgress', onStopProgress)
  $game.events.on('policeStopRabbit', onRabbit)
  $game.events.on('policeComputerAhead', onAhead)
  $game.events.on('policeStopPrompt', onStopPrompt)
  $game.events.on('policeStopActionMenuConfirmed', onStopActionMenuConfirmed)
...
onUnmounted(() => {
  ...
  $game.events.off('policeStopInitiated', onStopInitiated)
  $game.events.off('policeStopProgress', onStopProgress)
  $game.events.off('policeStopRabbit', onRabbit)
  $game.events.off('policeComputerAhead', onAhead)
  $game.events.off('policeStopPrompt', onStopPrompt)
  $game.events.off('policeStopActionMenuConfirmed', onStopActionMenuConfirmed)
